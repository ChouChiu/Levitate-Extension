...
当事件发生时，及时报告非常重要。要报告可能的违规行为，请[提交 Issue](https://github.com/ChouChiu/Levitate-Extension/issues) 或直接联系项目维护者。
...
本行为准则改编自[贡献者公约][homepage] 3.0 版，该公约永久可在此查阅：[https://www.contributor-covenant.org/version/3/0/][v3.0]。

贡献者公约由 Organization for Ethical Source 负责维护，并以 [CC BY-SA 4.0][cc] 许可协议发布。

关于贡献者公约的常见问题解答，请参阅 [FAQ][faq]。各语言版本译文请见 [https://www.contributor-covenant.org/translations][translations]。更多执行与社区指南资源请见 [https://www.contributor-covenant.org/resources][resources]。本分级措施的灵感来源于 [Mozilla 行为准则团队][mozilla] 的工作。
